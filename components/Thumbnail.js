...
export default function Thumbnail({ listingData, location}) {
    ...
    <div>
        ...
        <div className='font-medium text-gray-600'>Calculate curr distance ?</div>
        <div className='font-medium text-gray-600'>Dates Available</div>
        <div> <span className='font-bold'>${listingData.price}</span> night</div>
    </div>
  )
}
